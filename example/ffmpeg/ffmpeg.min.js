  ...
  return (
    (e = {
      497: (e, t, r) => {
        ...
        e.exports = { corePath: '/ffmpeg'.concat('/ffmpeg-core.js') };
      },
      663: (e, t, r) => {
      ...
      452: (e, t, r) => {
        ...
        var a = r(72),
          i = r(185).log,
          c = r(835).CREATE_FFMPEG_CORE_IS_NOT_DEFINED,
          s = (function () {
            var e = o(
              ...
              return regeneratorRuntime.wrap(function (e) {
                for (;;)
                  switch ((e.prev = e.next)) {
                    ...
                    case 3:
                      return (
                        (n = a(r)), (e.next = 6), s(n, 'application/javascript')
                      );
                    case 6:
                      return (
                        (o = e.sent),
                    ...
                    case 12:
                      if (
                        ((f = e.sent), 'undefined' != typeof createFFmpegCore)
                      ) {
                        e.next = 15;
                        break;
                      }
      ...
      906: (e, t, r) => {
        ...
        e.exports = function () {
          ...
          return (
            g(r),
            d(o),
            y('info', 'use ffmpeg.wasm v'.concat(F)),
            {
              setProgress: R,
              setLogger: T,
              setLogging: g,
          ...
          if ('string' == typeof e)
            if (e.startsWith('  Duration')) {
              var a = e.split(', ')[0].split(': ')[1],
                i = o(a);
              t({ duration: i, ratio: n }), (0 === r || r > i) && (r = i);
      ...
      666: (e) => {
        var t = (function (e) {
          ...
          var E = (v.prototype = d.prototype = Object.create(b));
          function F(e) {
